...
public class TC02_NA_DelAll {
	...
	{ 
		...
		//System.setProperty("webdriver.chrome.driver","C:/Users/Bhageshree/Documents/selenium/chromedriver.exe");
			...
			WebElement DelNA = driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div/div[3]/div/div[1]/div/div[1]/div/label/span/i//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div/div[3]/div/div[1]/div/div[1]/div/label/span/i"));
			Actions act3=new Actions(driver);
			act1.moveToElement(DelNA).click().perform();
						
			WebElement AllDelNA = driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div/div[2]/div/div/button"));
			Actions act4=new Actions(driver);
			act1.moveToElement(AllDelNA).click().perform();	
